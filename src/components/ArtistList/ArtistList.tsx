...
export default function ArtistList({ artists }: { artists: Artist[] }) {
    ...
    return (
        <section className='relative top-60 sm:top-72 my-16 bg-white flex flex-wrap flex-col mx-2 sm:mx-12 mb-8  sm:flex-row content-center sm:place-content-start 2xl:place-content-center shadow-xl rounded z-10'>
