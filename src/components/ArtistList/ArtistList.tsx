...
export default function ArtistList({ artists }: { artists: Artist[] }) {
    ...
    return (
        <section className='relative top-60 sm:top-72 mt-16 bg-white flex flex-wrap flex-col mx-8 sm:mx-12 mb-8  sm:flex-row content-center sm:place-content-start 2xl:place-content-center shadow-xl z-10'>
