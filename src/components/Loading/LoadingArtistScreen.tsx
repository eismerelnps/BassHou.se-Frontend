        ...
        <div className=" animate-pulse relative top-72   mx-8 mt-2  md:mx-24 md:mt-4 px-4 py-8">
            ...
            <div className=" flex flex-col sm:flex-row justify-center mt-2 ">
                <div className='sm:basis-3/5 '>
                    ...
                    <div className='flex flex-col justify-center space-y-2 my-4 me-24'>
                ...
                <section className='basis-2/5'>
                    ...
                    <article className='border  p-4'>
                        <div className='flex flex-col  mt-2 space-y-4'>
                            ...
                            <div className='flex row items-center space-x-2 justify-center'>
                                <div className=" h-8 w-8  bg-slate-700 rounded-full"></div>
                                <div className=" h-2  w-16 bg-slate-700 rounded"></div>
                                <div className=" h-1  w-8 bg-slate-700 rounded"></div>
                            </div>
            ...
            <section className='my-4'>
                ...
                <article className='flex flex-col justify-center mx-24'>
