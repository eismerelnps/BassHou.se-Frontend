...
export default function ArtistScreen({ artists }: { artists: Artist[] }) {
  ...
  if (artist) {
      ...
      md:mx-24 md:mt-4 px-4 py-8 '>
        ...
        <section className='my-4'>
          ...
          <div className='flex justify-center'>
            <iframe width="768" height="480" src={youtubeVideo} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
          </div>
        </section>
    ...
    <div className='basis-11/12 overflow-x-scroll'>
      <div className='flex flex-row mx-8 whitespace-nowrap'> 
        {
